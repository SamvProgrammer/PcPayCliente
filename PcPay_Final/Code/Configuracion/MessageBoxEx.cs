    ...
    public static class MessageBoxEx
    {
        ...
        private static void CenterWindow(IntPtr hChildWnd)
        {
            try
            {
                ...
                //double width = recChild.Width - recChild.RadiusX;
                //double height = recChild.Height - recChild.RadiusY;

                ////Rectangle recParent = new Rectangle(0, 0, 0, 0);
                ////success = GetWindowRect(_owner.Handle, ref recParent);
                //Rectangle recParent = new Rectangle();
                //success = GetWindowRect(hChildWnd, ref recParent);

                //Point ptCenter = new Point(0, 0);
                //////ptCenter.X = recParent.X + ((recParent.Width - recParent.X) / 2);
                //////ptCenter.Y = recParent.Y + ((recParent.Height - recParent.Y) / 2);
                //ptCenter.X = recParent.RadiusX + ((recParent.Width - recParent.RadiusX) / 2);
                //ptCenter.Y = recParent.RadiusY + ((recParent.Height - recParent.RadiusY) / 2);
                ...
                //int result = MoveWindow(hChildWnd, (int)ptStart.X, (int)ptStart.Y, (int)width, (int)height, false);
            }
            catch
            { }
